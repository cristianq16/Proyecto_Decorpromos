  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a class="destacados" href="destacados"><i  class="fa fa-link"></i> <span>Trabajos destacados</span></a></li>
        <li ><a class="cotizaciones" href="cotizaciones"><i class="fa fa-link"></i> <span>Cotizaciones</span></a></li>

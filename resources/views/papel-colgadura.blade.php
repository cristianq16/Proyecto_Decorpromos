...
<div id="carousel1" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('img/productos/papel-colgadura/slider-1.jpg')">
        ...
        <div class="carousel-item" style="background-image: url('img/productos/papel-colgadura/slider-2.jpg')">
        <div class="carousel-caption">
            <h3>papel de colgadura</h3>
        ...
        <div class="carousel-item" style="background-image: url('img/productos/papel-colgadura/slider-3.jpg')">
        <div class="carousel-caption">
            <h3>papel de colgadura</h3>
        ...
        <div class="row">
            <div class="col-md-6" ">
                <div class="text-center mt-5">
                    <img src="img/productos/papel-colgadura/papel-colgadura-descripcion.webp" alt="Cortina romana descripcion" >
                </div>
                <h1>Papel de colgadura</h1>
                <p class="mb-4">Las divisiones de los pliegues de nuestras cortinas papel-colgadura se forman gracias a los perfiles de aluminio que éstas llevan por la cara de atrás. Nuestros perfiles se destacan por ser delgados y estilizados y vienen en 5 colores que se coordinan con el color de la tela para darle al producto unidad estética.
                    <br><br>
                La tela no lleva costuras con lo cual se logra un terminado limpio y moderno. Esto, sumado a la calidad y a los diseños de nuestros tejidos son la clave para hacer de nuestras cortinas papel-colgadura un producto único, funcional y decorativo para cubrir tus ventanas.</p>
            ...
            <div class="col-md-6 imagenFila1-papel-colgadura">
            </div>
        </div>
    </div>
</section>
...
<section class="fila2">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 imagenFila2-papel-colgadura">
            </div>
                ...
                <div class="accordion mb-5" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                <p>Descubre el portafolio más amplio de telas para cortinas papel-colgadura, las cuales agrupamos así: Tejidos técnicos (screen y membranas bioclimáticas), tejidos decorativos y blackout.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
                                Las cortinas papel-colgadura Pentagrama tienen tres tipos de accionamiento: el cordel estándar, el cordel continuo y por
                                control remoto.
                            </div>
                        </div>
                    </div>
    ...
    <div class="container destacados">
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                ...
                <p>Manejamos diferentes perfiles inferiores en la fabricación de las cortinas papel-colgadura. El estándar es el perfil out
                disponible en cinco colores que se coordinan con la tela.</p>
            </div>
            <div class="col-md-4 text-center">
                <img src="img/prieza.jpg" alt="Riel" class="mb-3">
                <p>Los perfiles de aluminio de nuestras cortinas papel-colgadura evitan las costuras visibles sobre la tela mejorando su

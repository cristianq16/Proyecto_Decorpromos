...
<div id="carousel1" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('img/productos/sheer-royale/slider-1.jpg')">
        ...
        <div class="carousel-item" style="background-image: url('img/productos/sheer-royale/slider-2.jpg')">
        <div class="carousel-caption">
            <h3>sheer royale</h3>
        ...
        <div class="carousel-item" style="background-image: url('img/productos/sheer-royale/slider-3.jpg')">
        <div class="carousel-caption">
            <h3>sheer royale</h3>
        ...
        <div class="row">
            <div class="col-md-6" ">
                <div class="text-center mt-5">
                    <img src="img/productos/sheer-royale/sheer-royale-descripcion.webp" alt="Cortina sheer royale descripcion" >
                </div>
                <h1>Sheer-royale</h1>
                <p class="mb-4">El diseño de interiores apunta cada vez más al minimalismo y nuestras cortinas Sheer Royale están en total sintonía con esta tendencia. El velo difumina la luz que entra en el espacio y aporta cierto nivel de privacidad para proteger tu intimidad. El cabezal y el perfil inferior van en concordancia con el estilo exclusivo de este producto.
                    <br><br>
                Conoce el portafolio de telas y déjate sorprender por los diseños únicos y las colecciones metalizadas.</p>
            ...
            <div class="col-md-6 imagenFila1-sheer-royale">
            </div>
        </div>
    </div>
</section>
...
<section class="fila2">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 imagenFila2-sheer-royale">
            </div>
                ...
                <div class="accordion mb-5" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                Escoge entre un amplio portafolio de telas de acuerdo al tamaño que desees en las franjas. Nuestras colecciones de persianas sheer royale cuentan con telas de 5cm y de 7.5cm, mientras que en sheer Nudesse contamos con telas de 6.5cm y 7.5cm. Adicionalmente, podrás elegir entre telas trasluz y telas Night (90% blackout) de acuerdo a los niveles de traslucidez que desees.
                            </div>
                        </div>
                    </div>
    ...
    <div class="container destacados">
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                ...
                <p>El cabezal de lujo viene en colores coordinados con la tela para darle a tu producto una mayor armonía.</p>
            </div>
            <div class="col-md-4 text-center">
                <img src="img/prieza.jpg" alt="Riel" class="mb-3">
                <p>Las sheer royale Pentagrama están disponibles en varias colecciones de acuerdo al tamaño de la franja: de 5cm, 6.5cm y 7.5cm, siendo la franja más ancha la que te permitirá mayor contacto con el exterior.</p>
            </div>
            <div class="col-md-4 text-center">
                <img src="img/prieza.jpg" alt="Riel" class="mb-3">
                <p>La transparencia y suavidad del velo te permitirán una mayor visibilidad y contacto con el exterior.</p>
            </div>
        </div>
        <div class="row">
            <div class="col">

            ...
            <div class="modal fade" id="fm-modal" tabindex="-1" role="dialog" area-labelledby="fm-modal" area-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{route('{pagina}.store', $pagina)}}" method="post" id="modalForm" >
                            {{csrf_field()}}
                                <div class="form-row">
                                ...
                                <input type="submit" required name="enviar2" id="enviar2" class="button button2" value="Enviar datos">
